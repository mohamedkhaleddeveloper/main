                    ...
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            <li class="active">
                             ...
                             <li class="active">
                                <i class="fa fa-fw fa-arrow-circle-o-downt"></i> التاريخ : {$datefrom} : {$dateto}  
                            </li>
                            <li class="active">
					 ...
					 <td><strong>الخصم </strong></td>
                                ...
                                {foreach from=$creditpay  key=k item=creditpay1}
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <a href="addition.php?act=reportcridt&idcr={$creditpay1.idcr}&id={$creditpay1.castumerid}&print=1">سداد  </a>
