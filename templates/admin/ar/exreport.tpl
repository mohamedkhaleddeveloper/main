                ...
                <div class="row">
				 ...
				 <form class="form" action="addition.php?act=exreports" method="POST">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control"  id="orderdate" name="exfrom" value="{if $exfrom eq Null}{else}{$exfrom}{/if}" placeholder="ادخل التاريخ ">
                                            </div>
                                            <div class="col-lg-4">
                                                <label>التاريخ إلى </label>
                                                <input type="text" class="form-control"  id="orderdate1" name="exto" value="{if $exto eq Null}{else}{$exto}{/if}" placeholder="ادخل التاريخ ">
                                            </div>
                                                                <div class="col-lg-2">
