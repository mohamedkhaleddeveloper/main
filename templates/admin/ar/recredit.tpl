             ...
             <table class="table table-bordered table-hover table-striped text-center">
                                ...
                                {foreach from=$credit   key=k item=credit1}
                                        <tr>
                                                <td>{$k+1}</td>
                                                <td>{$credit1.idcr}</td>
                                                <td><a href="addition.php?act=reportcridt&idcr={$credit1.idcr}&id={$castomerId}"><button class="btn btn-primary" type="button"><i class="fa fa-print"></i|></button></a></td>
                                                <td><a href="addition.php?act=reportcridt&idcr={$credit1.idcr}&id={$castomerId}&print=1"><button class="btn btn-primary" type="button"><i class="fa fa-print"></i|></button></a></td>
